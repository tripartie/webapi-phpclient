 ...
 */
class ModelUser implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_User';
     ...
     * Sets id
     *
     * @param int|null $id The User's Tripartie ID.
     *
     * @return self
     */
